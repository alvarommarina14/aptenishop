...
import { createProductSchema, ProductFormCreateInputs } from "@/lib/validations/admin/productFormSchema";
...
export default function ProductPageCreateForm() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <ProductForm id={"product-form"} register={register} onSubmit={handleSubmit(onSubmit)} errors={errors} />
      <button
        form="product-form"
        type="submit"
